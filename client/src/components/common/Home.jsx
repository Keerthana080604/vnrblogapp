    ...
    <div className='container'>
      {
        isSignedIn === false && <div>
          <p className="lead">Our platform is designed to empower individuals by providing seamless access to insightful content, fostering a space for learning and growth</p>
          <p className="lead">"With a user-centric approach, we strive to deliver an intuitive and engaging experience that aligns with your professional and personal aspirations</p>
          <p className="lead">Join a thriving community where innovation meets excellence, enabling you to expand your horizons and achieve your goals effortlessly.</p>
        </div>
      }
